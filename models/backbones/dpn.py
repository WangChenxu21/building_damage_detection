...
pretrained_settings = {
    'dpn68': {
        'imagenet': {
            'url': 'pretrained/dpn68-66bebafa7.pth',
            'input_space': 'RGB',
    ...
    'dpn68b': {
        'imagenet+5k': {
            'url': 'pretrained/dpn68b_extra-84854c156.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [124 / 255, 117 / 255, 104 / 255],
    ...
    'dpn92': {
        ...
        # },
        'imagenet+5k': {
            'url': 'pretrained/dpn92_extra-b040e4a9b.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [124 / 255, 117 / 255, 104 / 255],
    ...
    'dpn98': {
        'imagenet': {
            'url': 'pretrained/dpn98-5b90dec4d.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [124 / 255, 117 / 255, 104 / 255],
    ...
    'dpn131': {
        'imagenet': {
            'url': 'pretrained/dpn131-71dfe43e0.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [124 / 255, 117 / 255, 104 / 255],
    ...
    'dpn107': {
        'imagenet+5k': {
            'url': 'pretrained/dpn107_extra-1ac7121e2.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [124 / 255, 117 / 255, 104 / 255],
