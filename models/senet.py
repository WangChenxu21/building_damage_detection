...
pretrained_settings = {
    'senet154': {
        'imagenet': {
            'url': 'pretrained/senet154-c7b49a05.pth',
            'input_space': 'RGB',
    ...
    'se_resnet50': {
        'imagenet': {
            'url': 'pretrained/se_resnet50-ce0d4300.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnet101': {
        'imagenet': {
            'url': 'pretrained/se_resnet101-7e38fcc6.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnet152': {
        'imagenet': {
            'url': 'pretrained/se_resnet152-d17c99b7.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnext50_32x4d': {
        'imagenet': {
            'url': 'pretrained/se_resnext50_32x4d-a260b3a4.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
    ...
    'se_resnext101_32x4d': {
        'imagenet': {
            'url': 'pretrained/se_resnext101_32x4d-3b2fe3d8.pth',
            'input_space': 'RGB',
            'input_size': [3, 224, 224],
            'input_range': [0, 1],
            'mean': [0.485, 0.456, 0.406],
