...
class HighResolutionNet(nn.Module):
    ...
    def init_weights(self, pretrained='',):
        ...
        if os.path.isfile(pretrained):
            ...
            del pretrained_dict['last_layer.3.bias']
            ###################################################################
...
class HighResolutionNetDouble(nn.Module):

    def __init__(self, config, **kwargs):
        global ALIGN_CORNERS
        extra = config['MODEL']['EXTRA']
        super(HighResolutionNetDouble, self).__init__()
        ALIGN_CORNERS = config['MODEL']['ALIGN_CORNERS']
...
def get_seg_model_double(cfg, **kwargs):
    model = HighResolutionNetDouble(cfg, **kwargs)
    model.init_weights(cfg['MODEL']['PRETRAINED'])
...
if __name__ == "__main__":
    ...
    model = get_seg_model_double(cfg)
    print(model)
